...
export default function PatternGame({ question, onAnswer, onReplayAudio }) {
  ...
  return (
    <div className="w-full flex flex-col items-center gap-8">
      ...
      <div className="flex flex-wrap items-center justify-center gap-3 bg-stone-200 p-5 rounded-2xl border-4 border-stone-300 shadow-inner">
      ...
      <div className="flex flex-wrap justify-center gap-4 w-full">
        {question.options.map((opt) => (
          <motion.button
            ...
            className="bg-white border-4 border-stone-200 border-b-8 border-b-stone-300 hover:border-amber-400 hover:border-b-amber-500 rounded-2xl p-5 text-5xl shadow-md transition active:border-b-4 active:translate-y-1 cursor-pointer"
          >
            {opt.icon}
          </motion.button>
        ))}
